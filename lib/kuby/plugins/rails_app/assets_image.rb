  ...
  module Plugins
    module RailsApp
      class AssetsImage < ::Kuby::Docker::Image
        ...
        def initialize(base_image, dockerfile, registry_metadata_url = nil, main_tag = nil, alias_tags = [])
          super(dockerfile, base_image.image_url, base_image.credentials, registry_metadata_url, main_tag, alias_tags)
